...
source(here("data-raw","2006","sequence_2006.R"))
...
state       <- "Victoria"
state_short <- "Vic"
ceds_2018 <- list_divisions(filters=list(StateAb="VIC",`2007`=TRUE)) %>% pull(DivisionNm)
...
state_short <- "Nsw"
ceds_2018 <- list_divisions(filters=list(StateAb="NSW",`2007`=TRUE)) %>% pull(DivisionNm)
...
state       <- "Queensland"
state_short <- "Qld"
ceds_2018 <- list_divisions(filters=list(StateAb="QLD",`2007`=TRUE)) %>% pull(DivisionNm)
...
state_short <- "Sa"
ceds_2018 <- list_divisions(filters=list(StateAb="SA",`2007`=TRUE)) %>% pull(DivisionNm)
...
state_short <- "Wa"
ceds_2018 <- list_divisions(filters=list(StateAb="WA",`2007`=TRUE)) %>% pull(DivisionNm)
...
state_short <- "Nt"
ceds_2018 <- list_divisions(filters=list(StateAb="NT",`2007`=TRUE)) %>% pull(DivisionNm)
